...
\begin{document}
% OPTIONAL CALENDAR WITH LINKS TO EACH DAY WITH ENTRIES; ENTER STARTING DATE OR COMMENT OUT
% \tikzexternaldisable%
% {%
%     \let\%=\pgfcalendarshorthand%
%    \pgfcalendar{cal}{STARTING DATE}{\year-\month-\day}%
%    {%
%       \ifdate{equals=01-01}{{\par\normalsize\bfseries\hrulefill\%y0}}{}%
%       \ifdate{end of month=0}{\par\vspace*{1.3pt}{\bfseries\%m0}\makebox[0.75cm]{\dotfill}}{}%
%       % \%d0\hspace*{4.8pt}%
...
\dmlbsetdate{2016}{2}{1}% CHANGING DATE, DATA COLLECTION STILL ACTIVE UP TO PRESENT DATE
\input{./QQ/TEST/99-12}% INPUTTING RAW ONLY FOR DEMO PURPOSES
\dmlbsetdate{2019}{2}{1}% EXCERPT FROM MY LOGBOOK
% 01.02.19
   \QQQ{00:35}{ }{3}{5}{22}{45}{}%
   \QQQ{03:11}{6.6}{2}{ }{ }{ }{}%
   \QQQ{19:14}{ }{5}{x}{xx}{xx}{}%
...
% \dmlbsetdate{1423}{12}{24}% CHANGING DATE TO PAST POSSIBLE, BUT DATA COLLECTION IN SEP. DAT'S GETS FUCKED
% \input{./QQ/TEST/99-12}%
\end{longtable}
\end{document}