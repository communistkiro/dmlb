...
% COLORS ==============================
    ...
    % TABLE
    \definecolor{tableColor}{RGB}{180,232,248}% 150,232,248
    % \colorlet{tableColor}{pink}
    % HEADER/FOOTER
...
\begin{document}
    \global\advance\row 1\relax% ACCOUNT FOR LONGER FIRST CAPTION
% TIME/DATE BG DATA COLECTION IN MONTH CHUNKS
    \immediate\newwrite\periods
    \immediate\openout\periods=\myRelPath0.dat
    % SAVES DATA FROM FIRST DATE 00:00 TO SECOD DATE 00:00, I.E., INPUTTING A NON-EXTISTENT DATE WOULD CAUSE IT TO COLLECT UNTIL END OF DOC THEREBY RUINING CURRENT .DAT AND NOT STARTING NEW ONES/OVERWRITING OLD ONES
    \tograph{1999-12-21}{2000-01-26}%
    \tograph{2000-01-26}{2000-02-12}%
    \tograph{2016-02-02}{2016-04-05}%
    % \tograph{2236-12-24}{2237-01-24}%
    % \tograph{2237-01-24}{2237-02-12}%
    % \tograph{2666-05-05}{2666-06-24}%
    \immediate\closeout\periods
    %
    \immediate\newwrite\data
    %
    \newread\periods
    \openin\periods=\myRelPath0.dat % open streaming so \QQ can read periods
\begin{longtable}{ =r +r | +r +r +r +r +r | +m{\mym} }%
    ...
    % FOOTER
        \hline\endfoot%
    \showrowcolors%
\dmlbSetDate{1999}{12}{21}%
\input{./QQ/TEST}% 2000 IS NOT A TRUE LEAP YEAR BECAUSE DIVISIBLE BY 400
\dmlbSetDate{2016}{2}{1}%
\input{./QQ/TEST}%
% 01.02.19
    \QQQ{00:35}{ }{3}{5}{22}{45}{}%
    \QQQ{03:11}{6.6}{2}{ }{ }{ }{}%
