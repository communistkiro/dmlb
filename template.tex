...
\begin{document}
    \addtocounter{row}{1}% ACCOUNT FOR LONGER FIRST HEADER
% TIME/DATE BG DATA COLECTION IN MONTH CHUNKS
    \immediate\newwrite\periods
    \immediate\openout\periods=\myRelPath0.dat
    % \tograph{2000-01-01}{2000-01-26}% SAVE DATA FROM FIRST DATE 00:00 TO SECOD DATE 00:00;
    % \tograph{2000-01-26}{2000-02-20}% I.E., INPUTING "2000-02-21", WOULD CAUSE IT TO COLLECT UNTIL END OF DOC
    % \tograph{2019-02-01}{2019-02-23}% THEREBY RUINING THAT .DAT, AND THE POSSIBILITY FOR NEW .DATS TO GET CREATED
...
\begin{longtable}{ =r +r | +r +r +r +r +r | +m{\mym} }%
    ...
    % FOOTER
        \hline\endfoot%
    \showrowcolors%
\dmlbSetDate{2019}{2}{1}%
\input{./QQ/TEST}%
\dmlbSetDate{3000}{10}{1}%
% 01.02.19%
    \QQQ{00:35}{ }{3}{5}{22}{45}{}%
    \QQQ{03:11}{6.6}{2}{ }{ }{ }{}%
    \QQQ{19:14}{ }{5}{x}{xx}{xx}{}%
